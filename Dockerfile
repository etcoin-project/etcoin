...
# Create etcoin user
RUN adduser --system --group --disabled-password etcoin && \
	mkdir -p /wallet /home/etcoin/.etcoin && \
	chown -R etcoin:etcoin /home/etcoin/.etcoin && \
	chown -R etcoin:etcoin /wallet

# Contains the blockchain
VOLUME /home/etcoin/.etcoin
...
# switch to user etcoin
USER etcoin

ENTRYPOINT ["etcoind", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=14040", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=14041", "--non-interactive", "--confirm-external-bind"]
