...
* Running etcoin node, linked to private/public testnet. 
  ...
  [Manual](https://github.com/etcoinexamples/private-testnet) explaining how to run private testnet.
...
* Directory with pre-generated wallets
  ...
  By default, tests expect these wallets to be in ```/var/etcoin/testnet_pvt```. 
